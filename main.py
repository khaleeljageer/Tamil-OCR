...
class OCRManager(QWidget):
    ...
    def __init__(self):
        ...
        self.thread_pool.setMaxThreadCount(min(12, os.cpu_count() or 2))  # Limit concurrent threads
        self.total_pages = 0
...
class OCRApp(QMainWindow):
    def __init__(self):
        ...
        self.text_cache = {}  # Cache original OCR text for each page
        self.text_modified = {}  # Track which pages have been edited
